...
class User(AbstractBaseUser):
    ...
    bio          = models.CharField(max_length=240, null=True, blank=True, verbose_name='نام')
    pic          = models.ImageField(upload_to='user/', default='pic1.png')
    role         = models.PositiveSmallIntegerField(choices=UserType.ROLE, default=2, verbose_name='سطح')
